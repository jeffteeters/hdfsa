...
def calc_result(bun, s0a0, s0a2, s2a0, s2a2, p0, p1):
...
for opt in possible_options:
	...
	if bundle_sum == 0:
		(result_0, fail_count_0) = calc_result(0, s0a0, s0a2, s2a0, s2a2, p0, p1)
		(result_1, fail_count_1) = calc_result(1, s0a0, s0a2, s2a0, s2a2, p0, p1)
		...
		(result, fail_count) = calc_result(bun, s0a0, s0a2, s2a0, s2a2, p0, p1)
